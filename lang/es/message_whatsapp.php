...
$string['retention_desc'] = 'Días que se conserva una entrada terminada de la cola (enviada, entregada, leída, fallada u omitida) antes de que la tarea de limpieza la borre junto con el registro de sus clics. Las entradas que todavía esperan para salir no las borra nunca. El reporte de envíos sólo puede mostrar lo que todavía no se borró.';
