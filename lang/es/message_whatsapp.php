...
$string['gatewayapikey_desc'] = 'Clave que el gateway emitió para este sitio. Se muestra una sola vez al dar de alta la suscripción y no se puede volver a leer: una clave perdida es una clave nueva.';
$string['gatewaysettings'] = 'Servicio gateway';
$string['gatewaysettings_desc'] = 'Dirección y clave del servicio gateway de WhatsApp, que se usan en modo gateway. En modo directo no se usan. En este modo la cuenta de WhatsApp, las plantillas aprobadas y los informes de entrega son del servicio, así que este sitio no necesita credenciales propias de Meta.';
$string['gatewayurl'] = 'Dirección del servicio';
$string['gatewayurl_desc'] = 'Dirección base del gateway, por ejemplo https://wa.ejemplo.com. La API key viaja en cada pedido que se le hace, así que acá va sólo una dirección de confianza.';
